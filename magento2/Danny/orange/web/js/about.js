...
require([
    ...
    $(document).ready(function (){
        ...
        // var drank = $("#drank");
        // var nate = $("#natepic");
        var nate = document.getElementById( 'natepic' );
        ...
        $("#drank").click( function () {
            if (uno.text().indexOf("Nathan") >= 0 ) {
                ...
                // console.log("Drank Clicked");
                grayscale( nate );
                grayscale.reset( drank );
        ...
        $("#natepic").click( function () {
            if (uno.text().indexOf("24") >= 0 ) {

                // console.log("Nate Clicked");
                grayscale( drank );
                grayscale.reset( nate );
